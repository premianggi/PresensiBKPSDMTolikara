    ...
    <div class="row">
        <div class="col-md-4">
                <table class="table table-bordered">
                    <tr>
                        <td><img src="{{ asset('uploads/'.$pegawai->foto)}}" width="180"></td>
        ...
        <div class="col-md-8">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td>Gaji Pokok</td>
                    <td>@format_uang($pegawai->gaji_pokok)</td>
                    <td>Tetap</td>
                </tr>
                <tr>
                    <td>Tunjangan Jabatan</td>
                    <td>@format_uang($pegawai->tunjangan_jabatan)</td>
                    <td>Tunjangan</td>
                    <td></td>
                </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ Form::open(['url'=>'hapus-komponen-gaji-detail/'.$gd->id,'method'=>'delete'])}}
                                 <button type="submit" class="btn btn-danger"><i class="fa fa-trash-o fa-sm"></i>Hapus</button>
                                {{ Form::close()}}
                            </td>
                        </tr>
                        <?php
                ...
                <tr>
                    ...
                    <?php
                        ...
                        for($d=1; $d<=31; $d++)
                        {
                            ...
                            if (date('m', $time)==$month)       
                                //$list[]=date('Y-m-d-D', $time);
                                echo "<td>".chekKehadiran($pegawai->nip,date('Y-m-d', $time))."</td>";
                        }
                    ?>
                </tr>
                <tr>
                    ...
                    <?php
                        ...
                        for($d=1; $d<=31; $d++)
                        {
                            ...
                            if (date('m', $time)==$month)       
                                //$list[]=date('Y-m-d-D', $time);
                                echo "<td>".chekLembur($pegawai->nip,date('Y-m-d', $time))."</td>";
                        }
                    ?>
                    </tr>
            </table>
